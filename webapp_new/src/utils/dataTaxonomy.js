...
export function generalizeThreatScenario(raw) {
  ...
  if (
    value.includes("web exploit") ||
    value.includes("application exploit") ||
    value.includes("app_vulnerab") ||
    value.includes("http") ||
    value.includes("https") ||
    value.includes("apache") ||
    value.includes("tomcat") ||
    value.includes("coyote") ||
    value.includes("iis") ||
    value.includes("ajp")
  ) {
    return "Application Exploit";
  }
