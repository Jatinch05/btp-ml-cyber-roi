...
st.markdown("---")
st.caption("Notes: This dashboard reads `data/processed/enriched.csv` by default. If it is missing, a small sample dataset is used so you can demo visuals immediately.")
